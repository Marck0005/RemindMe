...
<body>
        ...
        <div class="container-fluid">
            <div class="container-fluid divLogo">
                <a class="navbar-brand" href="#">
                    <img src="media/rmlogo.png" alt="Logo" class="logo" width="40" height="40" class="d-inline-block"> Remind Me
                </a>
            </div>
    ...
    <div class="col-12" align=center>
        ...
        <a href='anadir.php'>
            <button type="button" class="btn btn-primary aniadir" data-bs-toggle="modal" data-bs-target="#exampleModal">
                <p>+</p>
        </button>
        </a>
    </div>
